...
async function testTeamUserOperations() {
  ...
  try {
    ...
    if (notificationSettings) {
      ...
      console.log(
        `      New invoices: ${notificationSettings.invoice_new ? "✅" : "❌"}`,
      );
      console.log(
        `      Paid invoices: ${notificationSettings.invoice_paid ? "✅" : "❌"}`,
      );
      console.log(
        `      Overdue invoices: ${notificationSettings.invoice_overdue ? "✅" : "❌"}`,
      );
      console.log(
        `      New customers: ${notificationSettings.customer_new ? "✅" : "❌"}`,
      );
    } else {
