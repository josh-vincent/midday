  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group flex h-full w-[--sidebar-width] flex-col border-r bg-background",
          className
        )}
        {...props}
      >
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ref={ref}
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-muted-foreground outline-none transition-colors",
        className
      )}
      {...props}
    />
