...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle text-[#666666] font-medium [&:has([role=checkbox])]:px-0 border-r last:border-none w-auto",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-4 py-2 align-middle [&:has([role=checkbox])]:px-0 border-r last:border-none",
      className,
    )}
    {...props}
  />
