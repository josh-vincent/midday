...
CREATE TABLE "jobs" (
	...
	"cubic_metre_capacity" numeric(10, 2),
	"job_date" date,
	...
	"price_per_cubic_meter" numeric(10, 2),
...
CREATE INDEX "short_links_short_id_idx" ON "short_links" USING btree ("short_id");--> statement-breakpoint
CREATE INDEX "short_links_team_id_idx" ON "short_links" USING btree ("team_id");--> statement-breakpoint
...
CREATE INDEX "team_settings_team_idx" ON "team_settings" USING btree ("team_id");--> statement-breakpoint
