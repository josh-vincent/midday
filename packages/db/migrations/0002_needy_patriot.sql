...
-- NOTE: get_payment_score function is defined in supabase/migrations/20250907_invoice_functions.sql
-- This migration originally created a conflicting version with 3 parameters that returned INTEGER
-- The correct version has 1 parameter (p_team_id) and returns a TABLE
