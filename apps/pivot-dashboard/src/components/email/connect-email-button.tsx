...
export function ConnectEmailButton() {
  const handleConnectGmail = () => {
    window.location.href = "/api/email/oauth/gmail/authorize";
  };

  const handleConnectOutlook = () => {
    window.location.href = "/api/email/oauth/outlook/authorize";
  };
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuItem onClick={handleConnectGmail}>
        ...
        <DropdownMenuItem onClick={handleConnectOutlook}>
          <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
            <path
              fill="currentColor"
