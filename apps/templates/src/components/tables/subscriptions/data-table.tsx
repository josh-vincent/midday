...
import { SubscriptionsSkeleton } from "./skeleton";
...
type Props = {
  ...
  loading?: boolean;
  hasFilters?: boolean;
  onSubscriptionClick?: (subscription: MockSubscription) => void;
  onEditSubscription?: (subscription: MockSubscription) => void;
  onViewSubscription?: (subscription: MockSubscription) => void;
...
export function DataTable({
  ...
  if (!tableData?.length) {
    return <EmptyState onCreateSubscription={onCreateSubscription} />;
  }
